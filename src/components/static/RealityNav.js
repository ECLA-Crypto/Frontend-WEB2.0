                ...
                <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
                    <Menu.Items className="origin-top-left absolute focus:outline-none flex bg-gray-300 py-2 mt-2 justify-between flex-wrap px-5 z-40">
                        <div className="py-1">
                            ...
                            <Menu.Item>
                                <Link to='/eclacommerce' className='text-gray-900 block py-2 text-sm font-medium'>ECLAHedge</Link>
                            </Menu.Item>
                            <Menu.Item>
                ...
                <Menu as="div" className="text-left">
                    ...
                    <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
                        <Menu.Items className="w-full focus:outline-none flex justify-between flex-wrap px-5 z-40">
                            ...
                            <Menu.Item>
                                <Link to='/eclacommerce' className='text-gray-300 block py-2 text-sm font-medium'>ECLAHedge</Link>
                            </Menu.Item>
                            <Menu.Item>
